                ...
                <form class="ui large form">
                    <div class="stacked segment">
                        ...
                        <div class="ui two column centered grid">
                            <div class="two colomn centered row">
                                ...
                                <div class="field">
                                    ...
                                    <input type="password" name="repeat_password" id="repeat_password" placeholder="Wachtwoord" required>
                                </div>
                            </div>
                        </div>
                        <div class="ui two column centered grid">
                            <div class="two colomn centered row">
                                ...
                                <div class="field">
                                    ...
                                    <input type="text" name="postalcode" id="postalcode" placeholder="Postcode..." required>
                                </div>
                            </div>
                        </div>
                        <div class="ui two column centered grid">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="birthdate" id="birthdate" placeholder="Geboorte datum (dd/mm/jjjj)..." required>
                        </div>
                        <div class="field">
                            ...
                            <input type="text" name="secretQuestion" id="secretQuestion" placeholder="Antwoord..." required>
                        </div>
