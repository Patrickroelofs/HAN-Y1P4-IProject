...
SQLCMD -f 65001 -i "%~dp0\1.CREATESCRIPT.sql"
ECHO.
...
SQLCMD -f 65001 -i "%~dp0\2.BATCH_CREATESCRIPT.sql"
ECHO.
...
SQLCMD -f 65001 -i "%~dp0\7.BATCH_CONVERSIESCRIPT.sql"
ECHO.
...
SQLCMD -f 65001 -i "%~dp0\8.ADMIN_INSERT.sql"
ECHO.
...
SQLCMD -f 65001 -i "%~dp0\9.BATCH_DROP.sql"
ECHO.
